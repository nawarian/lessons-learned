...
- `learning-records/0001` through `0005` — Session progression

### Key Findings So Far (for Lesson 0004+)
...
6. **All three families**: Continuous (Diffusion-LM), discrete transitions (D3PM/SEDD), masked (MDLM/LLaDA) — masked is the practical starting point
